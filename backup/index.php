...
<body class="h-full flex overflow-hidden font-sans bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100">
    ...
    <aside class="w-80 bg-white dark:bg-[#111827] border-r border-slate-200 dark:border-slate-800 flex flex-col h-full flex-shrink-0">
        ...
        <div class="flex-1 overflow-y-auto p-2 space-y-1">
            ...
            <div class="px-2 mb-2">
                <a href="create_group.php" class="w-full flex items-center justify-center gap-2 p-2.5 rounded-lg border border-dashed border-slate-300 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition text-xs font-bold">
